...
from gptopt.data_utils import process_and_save_docs, tokenize, write_datafile
...
parser.add_argument(
    "-t", "--tokenizer", type=str, default="gpt2", help="tokenizer to use"
)
parser.add_argument(
...
if name == "tiny_shakespeare":
    ...
    with open(raw_path, "r") as f:
        text = f.read()
    n = int(len(text) * 0.9)
    dataset = {"train": {"text": text[:n]}, "val": {"text": text[n:]}}
